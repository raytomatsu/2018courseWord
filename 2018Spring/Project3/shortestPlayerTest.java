...
import java.util.*;
/**
 * The test class shortestPlayerTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class shortestPlayerTest
{
    @Test
    public void testDijkstra(){
        ...
        ends.add(4);
        shortestPlayer test = new shortestPlayer(graph,10,1,ends);
        test.Dijkstra();
        int expected = 5;
    ...
    public void testCheckForExitD2(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(4);
        shortestPlayer test = new shortestPlayer(graph,1,1,ends);
    ...
    public void testAlgorithm1(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(1);
        shortestPlayer test = new shortestPlayer(graph,10,3,ends);
