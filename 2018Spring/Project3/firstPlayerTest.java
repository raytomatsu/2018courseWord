...
import java.util.*;
/**
 * The test class firstPlayerTest. 
 *
 * @author  (your name)
...
public class firstPlayerTest
{
    ...
    public void testDijkstra(){
        ...
        ends.add(4);
        firstPlayer test = new firstPlayer(graph,10,1,ends);
        test.Dijkstra();
        int expected = 5;
    ...
    public void testCheckForExitD2(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(4);
        firstPlayer test = new firstPlayer(graph,1,1,ends);
    ...
    public void testAlgorithm1(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(1);
        firstPlayer test = new firstPlayer(graph,10,3,ends);
