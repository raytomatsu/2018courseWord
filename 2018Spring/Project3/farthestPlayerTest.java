...
import java.util.*;
/**
 * The test class farthestPlayerTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class farthestPlayerTest
{
    @Test
    public void testDijkstra(){
        ...
        ends.add(4);
        farthestPlayer test = new farthestPlayer(graph,10,1,ends);
        test.Dijkstra();
        int expected = 5;
    ...
    public void testCheckForExitD2(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(4);
        farthestPlayer test = new farthestPlayer(graph,1,1,ends);
    ...
    public void testAlgorithm1(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(1);
        farthestPlayer test = new farthestPlayer(graph,5,3,ends);
        
        test.algorithm(3);
        
        assertEquals(test.getWhereTo(),4);
    }
    @Test
    public void testAlgorithm2(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(1);
        farthestPlayer test = new farthestPlayer(graph,61,3,ends);
