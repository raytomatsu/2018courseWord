...
import java.util.*;
/**
 * The test class lastPlayerTest.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class lastPlayerTest
{
    @Test
    public void testDijkstra(){
        ...
        ends.add(4);
        lastPlayer test = new lastPlayer(graph,10,1,ends);
        test.Dijkstra();
        int expected = 5;
    ...
    public void testCheckForExitD2(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(4);
        lastPlayer test = new lastPlayer(graph,1,1,ends);
    ...
    public void testAlgorithm1(){
        ...
        ArrayList<Integer> ends = new ArrayList<Integer>();
        ends.add(1);
        lastPlayer test = new lastPlayer(graph,10,3,ends);
